...
void merge(T data1[ ], int& n1, T data2[ ], int& n2){   //append data2 to the right of data1
    ...
    assert(n2>=0);
    int i = 0 ;
    //    cout<<"entered low level merge"<<endl;
    //    cout<<"size1 before merge: "<<n1<<endl;
    //    cout<<"array 1 before merge: "; print_array(data1,n1);cout<<endl;
    //    cout<<"size2 before merge: "<<n2<<endl;
    //    cout<<"array 2 before merge: "; print_array(data2,n2);cout<<endl;
    while(n2 > 0){
        attach_item(data1,n1,data2[i]);
        i++,n2--;
    }
    //    cout<<"size1 after merge: "<<n1<<endl;
    //    cout<<"array 1 after merge: "; print_array(data1,n1);cout<<endl;
    //    cout<<"size2 after merge: "<<n2<<endl;
    //    cout<<"array 2 after merge: "; print_array(data2,n2);cout<<endl;
    //    cout<<"exited low level merge"<<endl;
    assert(n1>=0 && n2==0);
...
void split(T data1[ ], int& n1, T data2[ ], int& n2){  //move n/2 elements from the right of data1      //and move to data2
    assert(n1>=0);
    assert(n2>=0);
    //    cout<<"entered low level split"<<endl;
    //    cout<<"size1 before low level split: "<<n1<<endl;
    //    cout<<"size2 before low level split: "<<n2<<endl;
    int j = 0;
    ...
    n2 = j;
    n1-=n2;
    //    cout<<"size1 after low level split: "<<n1<<endl;
    //    cout<<"size2 after low level split: "<<n2<<endl;
    //    cout<<"exited low level split"<<endl;
}
template <class T>
